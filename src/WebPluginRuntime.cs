...
internal sealed partial class WebPluginRuntime : IDisposable
{
    ...
    private object? ExecuteHostRequest(JsonElement payload)
    {
        ...
        return route switch
        {
            ...
            HostRequestRoute.PluginSurfaces => ExecuteSurfaceRequest(method, parameters),
    ...
    private static HostRequestRoute ResolveHostRequestRoute(JsonElement payload, string method)
    {
        ...
        return method switch
        {
            ...
            "surfaces.openWindow" or "surfaces.openPopup" or "surfaces.close" or "surfaces.closeAll" => HostRequestRoute.PluginSurfaces,
