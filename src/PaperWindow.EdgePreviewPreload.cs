...
public sealed partial class PaperWindow
{
    ...
    private MarkdownEdgePreviewPreload.ReadResult ReadMarkdownPreloadTarget()
    {
        ...
        if (!CanEnterEdgeCapsulePreview || IsEdgeCapsulePreviewOpen ||
            _edgeCapsuleHost?.MarkdownPreloadAnchor is not { } anchor) return MarkdownEdgePreviewPreload.ReadResult.Deferred;
        ...
        if (!TryConstrainEdgeCapsulePreviewToCurrentHostCapacity(size, out size)) return MarkdownEdgePreviewPreload.ReadResult.Deferred;
