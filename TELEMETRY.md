...
Canonical copy-paste queries for new users, DAU, completed-day totals, and latest-row inspection live in [`CLS_QUERIES.md`](.github/CLS_QUERIES.md). Dashboard queries must use that dedup-first shape instead of summing raw ingestion rows.
