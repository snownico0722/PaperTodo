...
internal static class SharedPreviewSemanticChecks
{
    internal static void Run()
    {
        ...
        Require(Visible("$x^2$") == "$x^2$", "formula source remains literal in edge browsing");
        Require(Visible(@"\(x+y\)") == @"\(x+y\)", "backslash formula source remains literal in edge browsing");
