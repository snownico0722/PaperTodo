...
- **皮肤实验**：保留默认纸片、云母、两种亚克力、描图纸、液态玻璃、Aero 和像素风八种皮肤，均支持独立配色；移除旧釉面皮肤及其绘制与资源，旧选择回退默认纸片。液态玻璃增强曲面边缘变化、指针高光和真实背景 RGB 色散，表面反光始终位于采样背景之上。Aero 保留清透染色和柔和斜反光，不增加磨砂或桌面采样。
