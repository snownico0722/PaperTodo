...
- **贴边胶囊多屏 / 左右侧**：拖动「收起全部」主胶囊调整整条贴边胶囊栈的位置。小幅拖动时主胶囊磁吸在边缘，上下滑动带动整条栈一起移动；横向拖离边缘后主胶囊单独跟随鼠标，不带动其他胶囊，松手时自动吸附到光标所在显示器的左侧或右侧。位置与所在屏幕会被记住，显示器拔除后自动回退到最近的屏幕。

**胶囊相关问题修正**
- **贴边胶囊起始高度与位置**：拖动「收起全部」主胶囊可自由调整贴边胶囊栈的位置（高度、左右侧、所在显示器）。
