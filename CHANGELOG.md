...
有人反馈，多屏幕下不同缩放比例，笔记收回会位移一下然后再收回，检查一下是否存在这个问题，我没复现出来
...
- 统一纸片左上角置顶入口为书钉图标：未置顶为空心书钉，已置顶为实心书钉，减少不同系统字体带来的显示差异。
...
- 优化贴边胶囊拖拽排序时的让位动画，减少排序过程中的生硬跳变。
- 修复贴边胶囊解锁为完整胶囊后跨屏拖拽时可能短暂偏离鼠标或闪烁的问题。
- 修复纸片窗口在不同显示比例的副屏拖拽最大化后可能没有移除阴影和圆角的问题。
