...
- 优化自定义色盘，点击色块即可弹出颜色盘选择颜色，同时保留 HEX 精确输入。
- 新增海盐、雾紫、沙丘三个内置配色主题。
- 新增自定义色盘，可编辑纸面、边框、文字、强调色、链接和危险色等主题颜色。
- 新增整体大小和胶囊大小设置，可按百分比调整纸片与胶囊显示尺寸。
- 胶囊支持自由悬浮与自动吸附切换，侧边栏胶囊队列仍可整体拖动。
- 普通胶囊和侧边栏胶囊在展开后可再次点击缩回。
